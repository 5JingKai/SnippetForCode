...
public class MailConfiguration {
	...
	public SessionProviderConfiguration feishuConfig() {
		return SessionProviderConfiguration.builder()
				...
				.protocol("imap")
				.sslEnabled(true)
				.username("wujingkai@travelhere-tech.com")
				.password("Y9rJAUhsbqnfNSN6")
				.build();
	}
	...
	public SessionProviderConfiguration leleFeishuConfig() {
		return SessionProviderConfiguration.builder()
				...
				.protocol("imap")
				.sslEnabled(true)
				.username("donglele@travelhere-tech.com")
				.password("2bcuDV0vor2EZCg5")
				.build();
	}
	...
	public SessionProviderConfiguration gmailConfig() {
		return SessionProviderConfiguration.builder()
				...
				.protocol("imap")
				.sslEnabled(true)
				.username("jingkaiwu77@gmail.com")
				.password("niqm ppsp uhhb jxlr")
				.build();
	}
